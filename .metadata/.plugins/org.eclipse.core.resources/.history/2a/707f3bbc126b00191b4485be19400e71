            ...
            <header id="header" class="border">
                <div class="container">
                    <nav class="navbar navbar-default">
                        <!--  Header Logo  -->
                   	<a class="navbar-brand" href="index.jsp"><img src="assets/img/Pl/liv.jpg"></a>
                        <!--  END Header Logo  -->
                        <!--  Menu  -->
                        <div id="sidemenu">
                                ...
                                <ul>
                                    <li class="submenu">
                                        ...
                                        <!-- <ul class="sub-menu">
                                            ...
                                            <li><a href="index-creative.html">여성</a></li>
                                        </ul> -->
                                    </li>
                                    <li class="submenu">
                                        <a href="awaykit.jsp">Away Kit</a>
                                       <!--  <ul class="sub-menu">
                                            <li><a href="index.html">남성</a></li>
                                            <li><a href="index-creative.html">여성</a></li>
                                        </ul> -->
                                    ...
                                    <li class="submenu">
                                        <a href="souvenir.jsp">기념품</a>
                                        <!-- <ul class="sub-menu">
                                            <li><a href="about.html">핸드폰케이스</a></li>
                                            <li><a href="page-image-header.html">스카프</a></li>
                                            <li><a href="services.html">머그컵</a></li>
                                        </ul> -->
                                    </li>
                                    <li class="submenu">
                                        <a href="fashion.jsp">패션</a>
                                       <!--  <ul class="sub-menu">
                                            <li><a href="portfolio-two-columns.html">남성</a></li>
                                            <li><a href="portfolio-three-columns.html">여성</a></li> 
                                        </ul> -->
                                    </li>
                       ...
                       <div class="col-md-12 padding-leftright-null">
                           <div id="home-header">
                               <div class="text">
                                   ...
                                   <p class="heading left max full grey-dark"><h2>리버풀 팬 사이트에 오신 여러분을 환영합니다.</h2></p>
                               </div>
                           </div>
                       </div>
                   </div>
